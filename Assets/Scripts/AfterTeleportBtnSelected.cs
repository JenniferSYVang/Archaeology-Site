...
namespace VRStandardAssets.Menu
{
    ...
    public class AfterTeleportBtnSelected : MonoBehaviour
    {
        public event Action<AfterTeleportBtnSelected> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
        public Transform shovelTestObject;
      ...
      //  [SerializeField] private string m_SceneToLoad;                      // The name of the scene to load.
        ...
        private void ActivateButton()
        {
            ...
            player.transform.position = shovelTestObject.position;
