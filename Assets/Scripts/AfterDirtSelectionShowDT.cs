...
namespace VRStandardAssets.Menu
{
    ...
    public class AfterDirtSelectionShowDT : MonoBehaviour
    {
        public event Action<AfterDirtSelectionShowDT> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
        public MeshRenderer dataTable;
        public Texture dataImage;
        public bool thisLevelWasSelected = false;
        ...
        private void ActivateButton()
        {
         ...
         //   if (m_CameraFade.IsFading)
          //      yield break;
            ...
            Debug.Log("about to dislay an image. In the " + dataImage.name + " ...");
            dataTable.material.mainTexture = dataImage;
            dataTable.enabled = true;
            
            
            thisLevelWasSelected = true;
