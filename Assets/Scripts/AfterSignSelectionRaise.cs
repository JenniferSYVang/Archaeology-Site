...
namespace VRStandardAssets.Menu
{
    ...
    public class AfterSignSelectionRaise : MonoBehaviour
    {
        public event Action<AfterSignSelectionRaise> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
        public bool fullBar = false;
        public char upOrDown = 'a';
        public ScriptMovePane level10Dirt;
        ...
        private void ActivateButton()
        {
            ...
            /*if(level10Dirt.isUpAllWay == true)
            {
                level10Dirt.startMovementDown();
                upOrDown = 1;
            }
            else
            {
                level10Dirt.startMovementUp();
                upOrDown = 2;
            }*/

            fullBar = true;

            if(level10Dirt.isUpAllWay == false)
            {
                level10Dirt.startMovementUp();
                upOrDown = 'u';
            }
