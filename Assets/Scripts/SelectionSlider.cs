...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        {
            Debug.Log("In SelectionSlider. OnEnable() method...");
            m_VRInput.OnDown += HandleDown;
            m_VRInput.OnUp += HandleUp;

            Debug.Log("In SelectionSlider. OnEnable() method...  PHASE2");
            m_InteractiveItem.OnOver += HandleOver;
            m_InteractiveItem.OnOut += HandleOut;

            Debug.Log("In SelectionSlider. OnEnable() method...  PHASE 3");
        }


        private void OnDisable()
        {
            Debug.Log("OnDisabled method....");
            m_VRInput.OnDown -= HandleDown;
            m_VRInput.OnUp -= HandleUp;

            m_InteractiveItem.OnOver -= HandleOver;
            m_InteractiveItem.OnOut -= HandleOut;
            Debug.Log("Leaving OnDisabled Method");
        }
        ...
        private void Update()
        {
            ...
            Debug.Log("Update for Selection Slider");
        }


        public IEnumerator WaitForBarToFill()
        {
            Debug.Log("Waiting for the bar to fill.....");
        ...
        private IEnumerator FillBar()
        {
         ...
         //   m_Audio.Play();
            ...
            Debug.Log("The Bar should be COMPLETLEY filled.");
        ...
        private void SetSliderValue(float sliderValue)
        {
            ...
            Debug.Log("SetSliderValue() method just finished");
        }
        ...
        private void HandleDown()
        {
            ...
            Debug.Log("HandleDown() method just finished");
        }
        ...
        private void HandleUp()
        {
            ...
            Debug.Log("HandleUp() method just finished");
        }
...
//            m_Audio.clip = m_OnOverClip;
 //           m_Audio.Play();
            ...
            Debug.Log("HandleOver() method just finished");
        }
        ...
        private void HandleOut()
        {
            ...
            Debug.Log("HandleOut() method just finished");
        }
    }
}